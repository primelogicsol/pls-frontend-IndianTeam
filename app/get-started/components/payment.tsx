...
export default function ProceedOptions({ projectData, onUpdate }: ProceedOptionsProps) {
  ...
  const handleProceed = () => {
    if (selectedOption === "secure") {
      ...
      window.open("https://calendly.com/your-consultation-link", "_blank")
            ...
            <CardContent className="pb-4">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                <div className="w-10 h-6 bg-gray-100 rounded flex items-center justify-center">
                  <Image src="/visa-icon.png" alt="Visa" width={20} height={12} />
                </div>
                <div className="w-10 h-6 bg-gray-100 rounded flex items-center justify-center">
                  <Image src="/mastercard-icon.png" alt="Mastercard" width={20} height={12} />
                </div>
                <div className="w-10 h-6 bg-gray-100 rounded flex items-center justify-center">
                  <Image src="/paypal-icon.png" alt="PayPal" width={20} height={12} />
                </div>
                <div className="w-10 h-6 bg-gray-100 rounded flex items-center justify-center">
                  <Image src="/upi-icon.png" alt="UPI" width={20} height={12} />
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="pb-4">
              ...
              <div className="flex items-center justify-center">
                <div className="w-20 h-16 bg-gray-100 rounded flex items-center justify-center">
                  <Image src="/calendar-icon.png" alt="Calendar" width={32} height={32} />
                </div>
              </div>
            </CardContent>
            <CardFooter className="pt-0">
