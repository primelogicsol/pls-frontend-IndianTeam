  ...
  return (
    <StaticPageLayout title="Privacy Policy">
      <div className="prose max-w-none">
        ...
        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">2. Information We Collect</h2>
        <p className="text-gray-700 mb-4">
          We collect different types of personal and non-personal data, including but not limited to:
        </p>

        <h3 className="text-lg font-semibold text-blue-600 mt-6 mb-3">a. Information You Provide to Us</h3>
        ...
        <h3 className="text-lg font-semibold text-blue-600 mt-6 mb-3">b. Information Collected Automatically</h3>
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li>
        ...
        <h3 className="text-lg font-semibold text-blue-600 mt-6 mb-3">c. Information from Third-Party Sources</h3>
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li>
        ...
        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">3. How We Use Your Information</h2>
        ...
        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">4. Data Sharing & Disclosure</h2>
        <p className="text-gray-700 mb-4">
          We never sell or rent your personal data. However, we may share your information under the following
          conditions:
        </p>

        <h3 className="text-lg font-semibold text-blue-600 mt-6 mb-3">a. Service Providers & Partners</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-lg font-semibold text-blue-600 mt-6 mb-3">b. Legal & Compliance Requirements</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-lg font-semibold text-blue-600 mt-6 mb-3">c. Business Transfers</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">5. Data Security & Protection Measures</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">6. Your Rights & Control Over Your Data</h2>
        <p className="text-gray-700 mb-4">Depending on your jurisdiction, you may have the following rights:</p>

        <h3 className="text-lg font-semibold text-blue-600 mt-6 mb-3">For GDPR (EU/UK) Users:</h3>
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li>
        ...
        <h3 className="text-lg font-semibold text-blue-600 mt-6 mb-3">For CCPA (California) Users:</h3>
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li>
        ...
        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">7. Data Retention Policy</h2>
        ...
        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">8. Third-Party Links & External Services</h2>
        <p className="text-gray-700 mb-6">
          Our website may contain links to third-party websites. We are not responsible for their privacy practices.
          Please review their policies before sharing personal data.
        </p>

        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">9. Children's Privacy</h2>
        <p className="text-gray-700 mb-6">
          Our services are not intended for children under 16. We do not knowingly collect data from minors.
        </p>

        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">10. Changes to This Privacy Policy</h2>
        <p className="text-gray-700 mb-6">
        ...
        <h2 className="text-xl font-bold text-blue-700 mt-8 mb-4">11. Contact Us</h2>
        <p className="text-gray-700 mb-4">
